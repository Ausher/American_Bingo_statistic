...
---
The game card is composed of 5X5,but the central is free which means the square is default bits .  (bits=ON=the position is in called number)
...
the amount of number we pick up is P   
